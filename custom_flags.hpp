#ifndef OPENPOSE_CUSTOM_FLAGS_HPP
#define OPENPOSE_CUSTOM_FLAGS_HPP
...
DEFINE_string(net_resolution, "464x464", "Multiples of 16. If it is increased, the accuracy potentially increases. If it is"
...
#endif // OPENPOSE_CUSTOM_FLAGS_HPP
